...
const Billing = () =>  (
  <section id="product" className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      <h2 className={styles.heading2}>Easily control your <br className="sm:block hidden" /> purchases and 
        wallets.</h2>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
      The most advanced protection system 
      will allow you to always stay safe and 
      not be afraid for your purchases 
      and payment cards.
      </p>
